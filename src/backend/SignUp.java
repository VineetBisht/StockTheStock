...
//            }
    ...
    public boolean endshift(Person person) {
        ...
        try {
            ...
            pst.executeUpdate();
            msg="Username: "+person.getUser_name()+"\nDate: "+dt+"\nStart Time: "+a+"\nEnd Time: "+time+"\nHours: "+
                    hrs+"\nSalary: "+sal;
            sendMail("simranjeet271@gmail.com",msg);
        }  catch (Exception s) {
            System.out.println(s);
            return false;
        }
    ...
    public  static void sendMail(String reciever,String msg) throws Exception{
        ...
        String toUser=reciever;
        Message message=prepareMessage(session,fromUser,toUser,msg);
    ...
    private static Message prepareMessage(Session session,String sender,String reciever,String msg) {
        try{
            ...
            message.setSubject("Shift Details");
            message.setText(msg);
            return message;
        }catch(Exception ex){
