...
public class Files {
    ...
    public static String jasperResourcePath="src/resources/template/Bill.jrxml";
    public static String jasperPath="src/resources/template/";
    public static String login="login";
    public static String loginFile="/resources/fxml/Login.fxml";
    public static String complaint="complaint";
    public static String complaintFile="/resources/fxml/Complaint.fxml";
    public static String employeeMain="employeeMain";
    public static String employeeMainFile="/resources/fxml/EmployeeMain.fxml";
    public static String SignUp="signup";
    public static String SignUpFile="/resources/fxml/SignUp.fxml";
    public static String tables="tables";
    public static String tablesFile="/resources/fxml/Tables.fxml";
